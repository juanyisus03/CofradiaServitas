<x-app-layout>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('users.store') }}" class="max-w-sm mx-auto mb-4 flex flex-col bg-darkerprimary space-y-8 border border-secondary rounded-lg p-4">
                @csrf


                <h1 class="max-w-sm text-2xl font-bold leading-none text-accent">Crear Usuario</h1>
